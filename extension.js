...
var distanceunit = "";
var distanceval = "";
console.log("#### SCTime for Kiwi IRC Version 1.4.1 ####");
...
function CheckForUpdate() {
    ...
    req.send(null);
    //console.log(req);
    let result = String(req.responseText.includes("Version 1.4.1")); // checks if the version in the readme matches the current version
